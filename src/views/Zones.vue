        ...
        <v-flex v-for="zone in zones" :key="zone.id">
          <v-card class="mx-2 my-2">
            ...
            <v-card-action>
              <router-link
                tag="btn"
                :to="{ name: 'Patios', params: {data: zone.yardsInside, zone:zone.name}}"
              >
              ...
              dangerLevel: [
                {
                  name: variado.name,
                  color: variado.color,
                  voluntareerLevel: variado.voluntareerLevel,
                  show: variado.show
                }
              ],
              dogsInside: [{}, {}, {}, {}, {}, {}, {}, {}, {}, {}]
              ...
              dangerLevel: [
                {
                  ...
                  voluntareerLevel: formacion.voluntareerLevel,
                  show: formacion.show
                }
              ],
              dogsInside: [{}, {}, {}, {}]
